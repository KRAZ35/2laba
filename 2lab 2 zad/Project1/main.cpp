...
int main(void)
{
	...
	while (1)
	{
		cout << "1 - Чтение из из файла строк, содержащих двузначные числа\n2 - Выход\n\n";
		cout << "Выбирете команду:\n";
		gets_s(str);
		count = 0;
		choise = atoi(str);
		while (str[count])//Является ли введенная заявка числом
		{
		...
		if (!flag)
		{
			...
			choise = atoi(str);//преобразование из строки в число
